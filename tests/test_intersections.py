...
def test_intersection_on_not_intersected_objects() -> None:
    ...
    result = is_intersected(p1=p1, p2=p2) and is_intersected(p1=p2, p2=p1)

    assert result is False, "Expected that partitions are not intersected..."
...
def test_intersection_on_intersected_objects() -> None:
    ...
    assert result is True, "Expected that partitions are intersected..."
